...
| `/projects/clients/:id` |           Deletes a client from a project           |
...
|  `/types/priority/:id`  |  Deletes a priority type and reset project in use   |
|  `/types/payment/:id`   |   Deletes a payment type and reset project in use   |
| `/types/allocation/:id` | Deletes a allocation type and reset project in use  |
